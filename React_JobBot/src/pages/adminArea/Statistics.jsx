...
const Statistics = () => {
          ...
          <>
            ...
            {(isPie)?(<div className='alldata'>
              <div className='wrapper2'>
                  <button onClick={handleButtonClick} disabled={isClicked}>Update Statistics</button>
    ...
    <div>
      <h1>Statistics</h1>
      <p className="date">The statistics here refer to the total number of <strong>chats</strong> made with JOBOT by the website's users</p>
      <  BasicTabs/>
    </div>
  );
};
