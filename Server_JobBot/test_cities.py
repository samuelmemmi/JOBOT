...
# get_cities_from_areas(areas, areas_to_remove)
def test_get_cities_from_areas():
    ...
    assert sorted(get_cities_from_areas(["Central"], ["Central", "Israel"])) == sorted(["Herzliya", "Jerusalem", "Netanya", "Petah Tikva", "Raanana", "Ramat Gan",
                        "Rishon LeZiyyon", "Tel Aviv", "Tel Aviv-Yafo", "Kfar Saba", "Rehovot", "Hod HaSharon",
                        "Bnei Brak", "Giv`atayim", "Lod", "Holon", "Yavne", "Ness Ziona"])
    assert sorted(get_cities_from_areas(["All"], ["North", "Northern","South", "Southern","Central", "Israel"])) == sorted(["Haifa", "Qiryat Gat","Ashdod", "Herzliya",
    ...
    assert sorted(get_cities_from_areas(["North","All"], ["North", "Northern","South", "Southern","Central", "Israel"])) == sorted(["Haifa", "Qiryat Gat","Ashdod", "Herzliya",
                        "Jerusalem", "Netanya", "Petah Tikva", "Raanana", "Ramat Gan","Rishon LeZiyyon", "Tel Aviv",
                        "Tel Aviv-Yafo", "Kfar Saba", "Rehovot", "Hod HaSharon",
                        "Bnei Brak", "Giv`atayim", "Lod", "Holon", "Yavne", "Ness Ziona"])
